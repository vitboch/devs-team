            ...
            <div className="carousel-inner">
                <div className="carousel-item active" data-bs-interval="5000">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                        ...
                        <p className="m-0">
                            Cтандартизированный язык гипертекстовой разметки
                ...
                <div className="carousel-item" data-bs-interval="5000">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                        <h5>JavaScript</h5>
                        <p className="m-0">
                            Это язык программирования, который используют
                ...
                <div className="carousel-item" data-bs-interval="5000">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                        <h5>React</h5>
                        <p className="m-0">
                            Это библиотека JavaScript с открытым кодом для
                ...
                <div className="carousel-item" data-bs-interval="5000">
                    ...
                    <div className="carousel-caption d-none d-md-block">
                        <h5>GitHub</h5>
                        <p className="m-0">
                            Крупнейший веб-сервис для хостинга IT-проектов и их
